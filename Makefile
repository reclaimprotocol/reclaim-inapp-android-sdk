...
build:
	...
	INAPP_SDK_VERSION=$(VERSION) ./gradlew clean assemble publishToMavenLocal -xtest -xlint -Pgroup=org.reclaimprotocol -Pversion=$(VERSION) -Dmaven.repo.local=$(ANDROID_DIST_DIR)
